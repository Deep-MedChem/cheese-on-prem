...
> accurate.
>
> **The licence step below does not.** It stages an air-gapped licence file by
> hand. Kubernetes defaults to **call-home**: the licence agent writes that file
> for you and renews it — see [../README.md](../README.md) § "Licence on kind".
...
- ~~license file at `/data/cheese_license_file.json`~~ — **not any more**: the
  call-home licence agent writes this file itself, see [../README.md](../README.md)

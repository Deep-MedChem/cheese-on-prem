...
3. Contact us to provide you with registry credentials (`CHEESE_AWS_ACCESS_KEY_ID` + `CHEESE_AWS_SECRET_ACCESS_KEY`) to be able to download CHEESE docker images. (Older installs may still use the legacy `CHEESE_PASSWORD`; it keeps working until you receive AWS keys.)
